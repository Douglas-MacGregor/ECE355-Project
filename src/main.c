...
// {
// 	trace_printf("Timer IRQ entered\n");
...
// 	//	trace_printf("EXTI2_3 IRQ entered\n");

// 	/* Check if EXTI2 interrupt pending flag is indeed set */
// 	if ((EXTI->PR & EXTI_PR_PR2) != 0)
// 	{
// 		//		trace_printf("entered first if\n");
// 		if (timerTriggered == 0)
// 		{
// 			TIM2->CNT = 0;
// 			overFlow = 0;
...
// 		{
// 			TIM2->CR1 &= ~(TIM_CR1_CEN);
// 			trace_printf("SystemCoreClock: %d\n", SystemCoreClock);
// 			trace_printf("clock cycles: %d\n", TIM2->CNT);

// 			int cycles = (TIM2->CNT) + (overFlow * 0xFFFFFFFF);
// 			int period = cycles / SystemCoreClock;
// 			int freq = 1 / cycles;

// 			trace_printf("total clock cycles: %d\n", cycles);
// 			trace_printf("Period %d s \n", period);
// 			trace_printf("freq %d periods/s \n", freq);
// 			timerTriggered = 0;
// 		}
// 		EXTI->PR |= EXTI_PR_PR2;
// 	}
